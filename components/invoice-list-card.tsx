...
import { Eye, FileText, MoreHorizontal, Download, Printer, Edit, CheckCircle, Trash2 } from 'lucide-react';
...
export interface InvoiceListCardProps {
  ...
  extraActions?: (invoice: InvoiceListItem) => React.ReactNode;
  emptyMessage?: string;
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 md:gap-3 shrink-0">
                    ...
                    {invoice.paymentStatus && invoice.paymentStatus !== 'not-applicable' && (
                      <span className={`text-xs px-2 py-0.5 rounded-full font-medium hidden sm:inline ${getPaymentBadgeClass(invoice.paymentStatus)}`}>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-background dark:bg-gray-900" onClick={(e) => e.stopPropagation()}>
                        <DropdownMenuItem
                          onSelect={(e) => { e.preventDefault(); e.stopPropagation(); onView(invoice); }}
                        >
                        ...
                        <DropdownMenuItem
                          onSelect={(e) => { e.preventDefault(); e.stopPropagation(); onDownload(invoice); }}
                        >
                        ...
                        <DropdownMenuItem
                          onSelect={(e) => { e.preventDefault(); e.stopPropagation(); onPrint(invoice); }}
                        >
